  ...
  return (
    <header className="flex h-16 flex-none items-center justify-between border-b border-line bg-background px-4 sm:px-[22px]">
      <div className="flex min-w-0 items-center gap-2.5">
        ...
        <span className="ml-1 hidden items-center gap-1 rounded-pill bg-secondary px-2.5 py-1 text-[11.5px] font-bold text-faint sm:inline-flex">
      ...
      <div className="flex items-center gap-2.5">
        <Link
          href="/"
          className="flex h-9 flex-none items-center whitespace-nowrap rounded-md px-3.5 text-[13.5px] font-semibold text-subtle hover:bg-secondary"
        >
          로그인
        </Link>
        <Link
          href="/"
          className="inline-flex h-[38px] flex-none items-center gap-1.5 whitespace-nowrap rounded-md bg-primary px-4 text-[13.5px] font-bold text-primary-foreground shadow-primary hover:bg-primary-hover"
        >
          무료로 시작하기
